...
const PolaroidWall: React.FC = () => {
  ...
  const polaroids: Polaroid[] = [
    ...
    { id: 5, image: '/10.jpg', frontText: 'Snowy Queen', caption: 'Embracing the thrill of the snow-covered slopes, feeling the cold breeze, and making unforgettable memories on this epic ski adventure!', rotation: 'rotate-2' },
    { id: 6, image: '/11.jpg', frontText: 'Mountain vibes', caption: 'Watching her walk through nature’s beauty, where every step she takes makes the world seem a little brighter. 💖', rotation: '-rotate-1' },
    { id: 7, image: '/12.jpg', frontText: 'Hotness ka Pitara', caption: 'Sometimes, it is the little things that make me smile like your playful pose and the way you light up my mood. 💫💖', rotation: 'rotate-2' },
